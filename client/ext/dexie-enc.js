 ...
 * @param encryption
 * @param wipeKeys
 * @returns {_Promise<*>|PromiseLike<ArrayBuffer>|*}
 */
 ...
 * @param encryption
 * @param tables []
 * @returns {_Promise<void>}
 */
const dexieEncMiddleware = ({ db, encryption = null, tables = [] }) => {
